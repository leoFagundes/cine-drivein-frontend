  ...
  if (isPhone) {
    return (
      <section className={style.inputContainer}>
        <label>
          ...
          {type == "password" ? (
            passwordEye ? (
              ...
              <FaRegEye className={style.eyeIco} onClick={handlePasswordEye} />
            )
          ) : (
            ""
          )}
        ...
        <InputMask
          mask="(99) 99999-9999"
          className={isValid || isValid === null ? "" : style.invalidInput}
          id={textLabel}
          type={inputType}
          value={value}
          onChange={onChange}
        ...
        {isValid || isValid === null ? (
          ...
          <span className={style.invalidMessage} role="alert">
            Campo inválido
          </span>
        )}
