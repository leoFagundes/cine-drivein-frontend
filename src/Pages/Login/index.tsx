...
export default function Login() {
    ...
    const handleSubmit = async () => {
        const providerReq = await UserRepositories.loginUser({ username, password });
    ...
    return (
        <section className={style.loginContainer}>
            ...
            <form className={style.formLogin}>
                ...
                />
                <ButtonPattern mainText='Entrar' type="button" onClick={() => handleSubmit()} />
                <span onClick={() => navigate("/signUp")} className={style.signUpLink}>Criar uma nova conta <BiSolidUserAccount size={16} color='#0088c2' /></span>
            </form>
        </section >
    )
}
